package com.example.PMS_Database.Entity;
...
public class Booking {
	...
	public Booking(Long id, String bookingId, @NotBlank(message = "Sender name is required") String senderName,
			@NotBlank(message = "Sender contact is required") @Pattern(regexp = "^\\d{10}$", message = "Sender contact must be 10 digits") String senderContact,
			...
			@NotBlank(message = "Receiver contact is required") @Pattern(regexp = "^\\d{10}$", message = "Receiver contact must be 10 digits") String receiverContact,
			@NotBlank(message = "Receiver address is required") String receiverAddress,
			@NotBlank(message = "Receiver PIN is required") @Pattern(regexp = "^\\d{6}$", message = "Receiver PIN must be 6 digits") String receiverPin,
			@NotNull(message = "Weight is required") Double weight,
			@NotBlank(message = "Description is required") String description,
			@NotBlank(message = "Packaging type is required") String packaging,
			@NotBlank(message = "Delivery speed is required") String deliverySpeed,
			@NotNull(message = "Pickup date is required") LocalDate pickupDate,
			@NotBlank(message = "Pickup time is required") String pickupTime, String userId, String status) {
		super();
		this.id = id;
